...
public class Question2 extends javax.swing.JFrame {
     ...
     */
    public Question2( int marks, int questionAnswered) {
        initComponents();
    ...
    private void checkAnsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkAnsBtnActionPerformed
        ...
        if(!ansBtn1.isSelected() && !ansBtn2.isSelected() && !ansBtn3.isSelected() && !ansBtn4.isSelected() ){
            ...
            if(ansBtn1.isSelected()){
                ...
                ansStatusLbl.setText("incorrect - answer is BREAK");
                ansStatusLbl.setForeground(white);
    ...
    private void submitNextBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitNextBtnActionPerformed
        ...
        if(!ansBtn1.isSelected() && !ansBtn2.isSelected() && !ansBtn3.isSelected() && !ansBtn4.isSelected() ){
            JOptionPane.showMessageDialog(null, "Please select an Answer");
             ...
             new Question3(marks,questionAnswered).setVisible(true);
             this.dispose();
